          ...
          {hotels.map((h) => (
            ...
            >
              ...
              <div className="relative max-w-xl px-8 sm:px-12">
                ...
                <h3 className="font-display text-3xl font-semibold text-gold-400 sm:text-4xl">{h.name}</h3>
                ...
                <a
                  ...
                  className="mt-6 inline-flex items-center rounded-card bg-gradient-to-r from-gold-500 to-gold-600 px-7 py-3 text-sm font-semibold text-navy-950 shadow-card transition-transform hover:scale-[1.03]"
                >
                  Book Now
                </a>
              </div>
